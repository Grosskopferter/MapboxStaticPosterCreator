...
set zoom=17.0
for /l %%o in (%lon%, %lonstep%, %lonEnd%) do for /l %%a in (%lat%, %latstep%, %latEnd%) do (curl https://api.mapbox.com/styles/v1/grant/cjppy2mdv0pvn2sqjsliywuig/static/11.%%a,48.%%o,%zoom%,0,0/1280x1280@2x?access_token=%MAPBOX_ACCESS_KEY% --output %%o-%%a.png)
